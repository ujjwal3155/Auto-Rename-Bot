...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('ᴍᴀɪɴ ❤️', url='https://t.me/Otaku_Vision_M'),
      InlineKeyboardButton('ᴛ-ɴᴇxᴜꜱ ❣️', url='https://t.me/Team_Nexus_M')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("ᴍʏ ꜱᴇɴꜱᴇɪ 💞", url='https://t.me/aye_ujjwal')
    ]])
    if Config.START_PIC:
